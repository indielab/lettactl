...
program
  ...
  .option('--compact', 'compact conversation history for agents that had changes applied')
  .option('--compact-tags <tags>', 'filter compaction to agents matching tags (comma-separated, AND logic)')
  .option('--compact-match <pattern>', 'filter compaction to agents matching glob pattern')
